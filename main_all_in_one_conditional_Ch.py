...
def function_model(DiGAE_or_GAE_or_LGNN, CP_or_CQR, SCORE, SEEDNUM, GNNCONV, Weighted, Conditional):
...
parser.add_argument('--SCORE', type=str, default='cqr', help='Description of SCORE option')
parser.add_argument('--GNNCONV', type=str, default='GraphConv', help='Description of GNNCONV option')
parser.add_argument('--CP_or_CQR', type=str, help='Description of CP_or_CQR option')
parser.add_argument('--Dataset', type=str, help='Description of Dataset option')
parser.add_argument('--DiGAE_or_GAE_or_LGNN', type=str, help='Description of DiGAE_or_GAE_or_LGNN option')
parser.add_argument('--SEEDNUM', type=int, help='Loop number!')
parser.add_argument('--Weighted', type=str, help='Description of containing weighted edge or not')
parser.add_argument('--Conditional', type=str, help='Description of it is conditioal model or not')
...
def main():
    ...
    # 执行其他函数
    function_model(DiGAE_or_GAE_or_LGNN, CP_or_CQR, SCORE, SEEDNUM, GNNCONV, Weighted, Conditional)
    #function2()
